...
import { useAddToProjectMutation } from "../../features/project/addPerformerApiSlice";

export default function Search({ data, id }: { data: EmployeeResponse[], id: string }) {
    ...
    const [addPerformer] = useAddToProjectMutation();

    async function onButton() {
        try {
            await addPerformer({ id: id, email: value }).unwrap();
            setTimeout(() => {
